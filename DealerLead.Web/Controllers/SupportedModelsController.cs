...
namespace DealerLead.Web.Controllers
{
    ...
    public class SupportedModelsController : Controller
    {
        ...
        {
            var supportedModels = _context.SupportedModel.Include(s => s.Make);
            return View(await supportedModels.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var supportedModel = await _context.SupportedModel.Include(s => s.Make)
        ...
        {
            ViewData["MakeOptions"] = new SelectList(_context.SupportedMake, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["MakeOptions"] = new SelectList(_context.SupportedMake, "Id", "Name", supportedModel.MakeId);
            return View(supportedModel);
        }
