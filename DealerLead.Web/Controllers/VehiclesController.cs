...
namespace DealerLead.Web.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MSRP,StockNumber,Color,SellDate,ModelId,DealershipId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MSRP,StockNumber,Color,SellDate,ModelId,DealershipId")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
